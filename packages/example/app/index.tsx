...
import { ScrollView, SafeAreaView, StatusBar, StyleSheet, TouchableOpacity } from 'react-native';
import { useRouter } from 'expo-router';
import { Box, Text, Heading, Button, HStack, VStack, Divider, useColorMode, Card } from 'kra-ui';
